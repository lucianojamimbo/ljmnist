...
sizes = [784,16,10] #this decides the shape of our network.
...
weights, biases = trainSGD(10, 20, 0.02, data, nabla_w_zero, nabla_b_zero, sizes, delta, weights, biases) #training time
